...
**推荐搭配 · Best paired with:** `resume-database-generic` — 先归档全部事实与 STAR，再按岗定向改写。没有素材库，每次改写都在重新翻 PDF；有库，筛选关用的是 **对的弹药**。  
...
- **目标 JD** — 文本 / 链接 / 截图
- **原始简历** 或 **`简历数据库.md`**（来自 resume-database-generic）
- **可选** — 岗位名、城市、证件照路径
